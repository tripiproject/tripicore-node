...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `tripicore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ tripicore-node add wallet-service');
      console.log('    $ tripicore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ tripicore-node remove wallet-service');
      console.log('    $ tripicore-node remove insight-api');
      console.log();
    });
